function segment_claustrum_lh(t1wFile, tt5File, fslSegFile, outFile)
...
dtiWriteNiftiWrapper(putamenEdge, putamen.qto_xyz, [outDir,'/L_putamenEdge.nii.gz']);
...
dtiWriteNiftiWrapper(candidate, putamen.qto_xyz, [outDir,'/L_candidate1.nii.gz']);
...
tmp(goodInd)=1;
dtiWriteNiftiWrapper(tmp, putamen.qto_xyz, [outDir,'/L_candidate_farFromCsf.nii.gz']);
candidate = tmp;
...
dtiWriteNiftiWrapper(kmeanLow, putamen.qto_xyz, [outDir,'/L_clstrm1_kmeansLow.nii.gz']);
kmeanHigh = zeros(size(candidate));
kmeanHigh(candidateIndices(kidx==2)) = 2;
dtiWriteNiftiWrapper(kmeanHigh, putamen.qto_xyz, [outDir,'/L_kmeansHigh.nii.gz']);
...
dtiWriteNiftiWrapper(smoothedClaustrum, putamen.qto_xyz, [outDir,'/L_clstrm3_kmeansLow_smooth25_inCandidates.nii.gz']);
